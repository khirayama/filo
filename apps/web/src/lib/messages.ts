...
const EXTRA_MESSAGES: Record<SupportedLanguage, MessageCatalog> = {
  ja: {},
  en: {
    "診断ログは端末内に最大100件保存されます。本文・ページ名・URLは含みません。": "Up to 100 diagnostic events are stored on this device. Article text, page titles, and URLs are excluded.", "診断ログをJSONで保存": "Save diagnostic log as JSON", "診断ログを保存しました。": "Diagnostic log saved.", "診断ログを保存できませんでした。": "Could not save the diagnostic log.",
  ...
  zh: {
    "診断ログは端末内に最大100件保存されます。本文・ページ名・URLは含みません。": "诊断日志最多在此设备上保存 100 条，不包含文章正文、页面标题或网址。", "診断ログをJSONで保存": "将诊断日志保存为 JSON", "診断ログを保存しました。": "诊断日志已保存。", "診断ログを保存できませんでした。": "无法保存诊断日志。",
  ...
  ko: {
    "診断ログは端末内に最大100件保存されます。本文・ページ名・URLは含みません。": "진단 로그는 이 기기에 최대 100개 저장됩니다. 본문, 페이지 제목, URL은 포함되지 않습니다.", "診断ログをJSONで保存": "진단 로그를 JSON으로 저장", "診断ログを保存しました。": "진단 로그를 저장했습니다.", "診断ログを保存できませんでした。": "진단 로그를 저장하지 못했습니다.",
  ...
  es: {
    "診断ログは端末内に最大100件保存されます。本文・ページ名・URLは含みません。": "Se guardan hasta 100 eventos de diagnóstico en este dispositivo. No se incluyen el texto, los títulos ni las URL.", "診断ログをJSONで保存": "Guardar el registro de diagnóstico como JSON", "診断ログを保存しました。": "Registro de diagnóstico guardado.", "診断ログを保存できませんでした。": "No se pudo guardar el registro de diagnóstico.",
...
// Keep the catalog complete when a screen introduces copy that is shared by
// the web app and the extension. A missing entry would otherwise silently
// render the Japanese source phrase for that language.
const COMPLETION_MESSAGES: Record<SupportedLanguage, MessageCatalog> = {
  ja: {},
  en: {
    "サインアウト中…": "Signing out…",
    "サイドバー": "Sidebar",
    ...
    "並び順": "Sort order",
    "既読の扱い": "Read handling",
    "既読で並び替えない": "Do not sort by read status",
    "既読は下": "Read last",
    "既読は上": "Read first",
    "読み上げ": "Reading aloud",
  ...
  zh: {
    ...
    "削除処理に失敗しました": "删除失败",
    "設定へ戻る": "返回设置",
    "記事の取得が完了しています。": "文章已准备就绪。",
    "購読の追加は完了しました。記事を取得しています。": "订阅已添加，正在获取文章。",
    "初回取得失敗": "首次获取失败",
  ...
  ko: {
    ...
    "並び順": "정렬 순서",
    "既読の扱い": "읽음 처리",
    "既読で並び替えない": "읽음 상태로 정렬하지 않음",
    "既読は下": "읽은 항목 나중",
    "既読は上": "읽은 항목 먼저",
    "削除処理に失敗しました": "삭제 처리에 실패했습니다",
    "設定へ戻る": "설정으로 돌아가기",
    "記事の取得が完了しています。": "기사를 가져올 준비가 되었습니다.",
    "購読の追加は完了しました。記事を取得しています。": "구독이 추가되었습니다. 기사를 가져오는 중입니다.",
    "初回取得失敗": "최초 가져오기 실패",
    "既読の記事をリーディングリストから削除しますか？": "읽은 기사를 읽기 목록에서 삭제할까요?",
    "既読記事を削除": "읽은 기사 삭제",
  ...
  es: {
    "サインアウト中…": "Cerrando sesión…",
    "サイドバー": "Barra lateral",
    "メインナビゲーション": "Navegación principal",
    "記事を追加": "Añadir artículo",
    "更新異常": "Error de actualización",
    "しばらく更新なし": "Sin actualizaciones recientes",
    "記事一覧": "Lista de artículos",
    "ブックマークを解除": "Quitar marcador",
    "表示設定": "Configuración de vista",
    "既読状態": "Estado de lectura",
    "並び順": "Orden",
    "既読の扱い": "Gestión de leídos",
    "既読で並び替えない": "No ordenar por leído",
    "既読は下": "Leídos al final",
    "既読は上": "Leídos primero",
    "削除処理に失敗しました": "Error al eliminar",
    "設定へ戻る": "Volver a ajustes",
    "記事の取得が完了しています。": "Los artículos están listos.",
    "購読の追加は完了しました。記事を取得しています。": "Suscripción añadida. Obteniendo artículos.",
    "初回取得失敗": "Error en la obtención inicial",
    "既読の記事をリーディングリストから削除しますか？": "¿Quitar los artículos leídos de la lista de lectura?",
    "既読記事を削除": "Quitar artículos leídos",
...
const READER_MESSAGES: Record<SupportedLanguage, MessageCatalog> = {
  ja: {},
  en: {
    "リーディングリストに追加しました。": "Added to your reading list.",
    "準備しています…": "Preparing…",
    "翻訳を利用できないため原文で読み上げています。": "Translation is unavailable, so the original text is being read.",
    "キーボードショートカット": "Keyboard shortcuts",
    "このページは読み上げできません。": "This page cannot be read aloud.",
    "読み上げ音声から応答がありませんでした。": "The speech voice did not respond.",
    "読み上げ音声でエラーが発生しました。": "The speech voice reported an error.",
    "音声エンジンが発話を開始しませんでした。読み上げ音声の設定やOSの音声出力を確認してください。": "The speech engine did not start. Check the voice setting and your system's audio output.",
    "音声エンジンの状態を確認できませんでした。": "Could not check the speech engine.",
    "記事を開けませんでした。": "Could not open the article.",
    "J  次の記事": "J  Next article",
    "K  前の記事": "K  Previous article",
    "?  ショートカット一覧を表示": "?  Show shortcuts",
  },
  zh: {
    "リーディングリストに追加しました。": "已加入阅读列表。",
    "準備しています…": "正在准备…",
    "翻訳を利用できないため原文で読み上げています。": "无法使用翻译，正在朗读原文。",
    "キーボードショートカット": "键盘快捷键",
    "このページは読み上げできません。": "无法朗读此页面。",
    "読み上げ音声から応答がありませんでした。": "朗读语音没有响应。",
    "読み上げ音声でエラーが発生しました。": "朗读语音发生错误。",
    "音声エンジンが発話を開始しませんでした。読み上げ音声の設定やOSの音声出力を確認してください。": "语音引擎未开始朗读。请检查朗读语音设置和系统的音频输出。",
    "音声エンジンの状態を確認できませんでした。": "无法确认语音引擎的状态。",
    "記事を開けませんでした。": "无法打开文章。",
    "J  次の記事": "J  下一篇文章",
    "K  前の記事": "K  上一篇文章",
    "?  ショートカット一覧を表示": "?  显示快捷键",
  ...
  ko: {
    "リーディングリストに追加しました。": "리딩 리스트에 추가했습니다.",
    "準備しています…": "준비 중…",
    "翻訳を利用できないため原文で読み上げています。": "번역을 사용할 수 없어 원문을 낭독하고 있습니다.",
    "キーボードショートカット": "키보드 단축키",
    "このページは読み上げできません。": "이 페이지는 낭독할 수 없습니다.",
    "読み上げ音声から応答がありませんでした。": "낭독 음성이 응답하지 않았습니다.",
    "読み上げ音声でエラーが発生しました。": "낭독 음성에서 오류가 발생했습니다.",
    "音声エンジンが発話を開始しませんでした。読み上げ音声の設定やOSの音声出力を確認してください。": "음성 엔진이 낭독을 시작하지 않았습니다. 낭독 음성 설정과 시스템 오디오 출력을 확인해 주세요.",
    "音声エンジンの状態を確認できませんでした。": "음성 엔진 상태를 확인할 수 없습니다.",
    "記事を開けませんでした。": "기사를 열 수 없습니다.",
    "J  次の記事": "J  다음 기사",
    "K  前の記事": "K  이전 기사",
    "?  ショートカット一覧を表示": "?  단축키 보기",
  },
  es: {
    "リーディングリストに追加しました。": "Añadido a tu lista de lectura.",
    "準備しています…": "Preparando…",
    "翻訳を利用できないため原文で読み上げています。": "La traducción no está disponible, así que se lee el texto original.",
    "キーボードショートカット": "Atajos de teclado",
    "このページは読み上げできません。": "Esta página no se puede leer en voz alta.",
    "読み上げ音声から応答がありませんでした。": "La voz de lectura no respondió.",
    "読み上げ音声でエラーが発生しました。": "La voz de lectura produjo un error.",
    "音声エンジンが発話を開始しませんでした。読み上げ音声の設定やOSの音声出力を確認してください。": "El motor de voz no empezó a hablar. Revisa la voz elegida y la salida de audio del sistema.",
    "音声エンジンの状態を確認できませんでした。": "No se pudo comprobar el motor de voz.",
    "記事を開けませんでした。": "No se pudo abrir el artículo.",
    "J  次の記事": "J  Artículo siguiente",
    "K  前の記事": "K  Artículo anterior",
    "?  ショートカット一覧を表示": "?  Mostrar atajos",
  },
};
